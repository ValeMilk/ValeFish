...
const PrintableLote = React.forwardRef<HTMLDivElement, PrintableLoteProps>(
  ({ lote, username }, ref) => {
    ...
    return (
      <div ref={ref} className="p-4 bg-white" style={{ width: '210mm', fontSize: '11px', lineHeight: '1.3' }}>
        <style>{`
          @media print {
            @page {
              size: A4;
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-center">
                <QRCodeSVG 
                  ...
                  includeMargin={false}
                />
                <p style={{ fontSize: '8px', margin: '2px 0 0 0' }} className="text-gray-500">Lote {lote.numeroLote}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Informações Básicas */}
        <div className="mb-2">
          <h2 style={{ fontSize: '12px', margin: '0 0 4px 0', textTransform: 'uppercase', letterSpacing: '0.3px' }} className="font-bold text-gray-800 border-b border-gray-300 pb-1">
            Informações do Lote
          </h2>
          <div className="grid grid-cols-6 gap-1.5" style={{ fontSize: '10px' }}>
            <div className="bg-gray-50 p-1.5 rounded">
              <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Data Produção</p>
              <p className="font-semibold" style={{ fontSize: '10px', margin: 0 }}>{lote.dataProducao ? new Date(lote.dataProducao).toLocaleDateString('pt-BR') : '-'}</p>
            </div>
            <div className="bg-gray-50 p-1.5 rounded">
              <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Processo</p>
              <p className="font-semibold" style={{ fontSize: '10px', margin: 0 }}>{lote.processo}</p>
            </div>
            <div className="bg-gray-50 p-1.5 rounded">
              <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Fornecedor</p>
              <p className="font-semibold" style={{ fontSize: '10px', margin: 0 }}>{lote.fornecedor}</p>
            </div>
            <div className="bg-blue-50 p-1.5 rounded">
              <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Nº Lote</p>
            ...
            <div className="bg-gray-50 p-1.5 rounded">
              ...
              <p className="font-semibold" style={{ fontSize: '10px', margin: 0 }}>{lote.numeroNF || '-'}</p>
            </div>
            <div className="bg-yellow-50 p-1.5 rounded">
              <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Valor Transferência</p>
        ...
        {/* Nota Fiscal e Peso */}
        <div className="mb-2">
          <h2 style={{ fontSize: '11px', margin: '0 0 4px 0', textTransform: 'uppercase', letterSpacing: '0.3px' }} className="font-bold text-gray-800 border-b border-gray-300 pb-1">
            Nota Fiscal e Peso
          </h2>
          <div className="flex gap-1.5 mb-1.5" style={{ fontSize: '10px' }}>
            <div className="bg-blue-100 border border-blue-300 p-1.5 rounded text-center flex-1">
              <p className="font-medium text-blue-700 mb-0" style={{ fontSize: '9px' }}>Total NF</p>
              <p className="font-bold text-blue-900" style={{ fontSize: '12px', margin: 0 }}>{totalNF.toFixed(2)} kg</p>
            </div>
            <div className="bg-green-100 border border-green-300 p-1.5 rounded text-center flex-1">
              <p className="font-medium text-green-700 mb-0" style={{ fontSize: '9px' }}>Total Salão</p>
              <p className="font-bold text-green-900" style={{ fontSize: '12px', margin: 0 }}>{totalSalao.toFixed(2)} kg</p>
            </div>
            <div className={`border p-1.5 rounded text-center flex-1 ${
              ...
              <p className={`font-bold ${gap >= 0 ? 'text-orange-900' : 'text-red-900'}`} style={{ fontSize: '12px', margin: 0 }}>{gap.toFixed(2)} kg</p>
            </div>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-300" style={{ fontSize: '10px' }}>
            <thead>
              <tr className="bg-gray-200">
                <th className="border border-gray-300 p-1 text-left" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Tipo</th>
                <th className="border border-gray-300 p-1 text-right" style={{ fontSize: '9px', textTransform: 'uppercase' }}>P (kg)</th>
                <th className="border border-gray-300 p-1 text-right" style={{ fontSize: '9px', textTransform: 'uppercase' }}>M (kg)</th>
                <th className="border border-gray-300 p-1 text-right" style={{ fontSize: '9px', textTransform: 'uppercase' }}>G (kg)</th>
                <th className="border border-gray-300 p-1 text-right" style={{ fontSize: '9px', textTransform: 'uppercase' }}>GG (kg)</th>
            ...
            <tbody>
              ...
              <tr className="bg-blue-50">
                <td className="border border-gray-300 p-1 font-medium">Nº Basquetas</td>
                <td className="border border-gray-300 p-1 text-right">{lote.numBasquetas?.P || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.numBasquetas?.M || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.numBasquetas?.G || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.numBasquetas?.GG || 0}</td>
        ...
        {/* Descartes */}
        <div className="mt-2">
          <h3 style={{ fontSize: '11px', margin: '0 0 4px 0', textTransform: 'uppercase', letterSpacing: '0.3px' }} className="font-bold text-gray-800 border-b border-gray-300 pb-1">
            Descartes
          </h3>

          <div className="bg-red-100 border border-red-300 p-1.5 rounded text-center mb-1.5">
            <p className="font-medium text-red-700 mb-0" style={{ fontSize: '9px' }}>Total de Descartes</p>
            <p className="font-bold text-red-900" style={{ fontSize: '12px', margin: 0 }}>{calcularTotal(lote.descartes).toFixed(2)} kg</p>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-300" style={{ fontSize: '10px' }}>
            ...
            <tbody>
              <tr className="bg-red-50">
                <td className="border border-gray-300 p-1 font-medium">Descartes</td>
                <td className="border border-gray-300 p-1 text-right">{lote.descartes?.P || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.descartes?.M || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.descartes?.G || 0}</td>
                <td className="border border-gray-300 p-1 text-right">{lote.descartes?.GG || 0}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        {lote.status === 'finalizado' && (
          <div className="mb-2">
            ...
            <div className="grid grid-cols-4 gap-1.5" style={{ fontSize: '10px' }}>
              <div className="bg-gray-50 p-1.5 rounded">
                <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Tipo Filé</p>
                <p className="font-semibold" style={{ margin: 0, fontSize: '10px' }}>{lote.tipoFile || '-'}</p>
              </div>
              <div className="bg-gray-50 p-1.5 rounded">
              ...
              <div className="bg-gray-50 p-1.5 rounded">
                ...
                <p className="font-semibold" style={{ fontSize: '10px', margin: 0 }}>{lote.dataValidade ? new Date(lote.dataValidade).toLocaleDateString('pt-BR') : '-'}</p>
              </div>
              <div className="bg-green-50 p-1.5 rounded">
                <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Aprov. NF</p>
                <p className="font-bold text-green-900" style={{ fontSize: '10px', margin: 0 }}>{aproveitamento.aprovNotaFiscal}%</p>
              </div>
              <div className="bg-green-50 p-1.5 rounded">
                <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Aprov. Salão</p>
                <p className="font-bold text-green-900" style={{ fontSize: '10px', margin: 0 }}>{aproveitamento.aprovSalao}%</p>
              </div>
              <div className="bg-blue-50 p-1.5 rounded">
                <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Custo Pacotes</p>
                <p className="font-bold text-blue-900" style={{ fontSize: '10px', margin: 0 }}>R$ {(lote.custoPacotes || custos.custoPacotes).toFixed(2)}</p>
              </div>
              <div className="bg-purple-50 p-1.5 rounded">
                <p className="text-gray-600 mb-0" style={{ fontSize: '8px' }}>Custo Caixas</p>
                <p className="font-bold text-purple-900" style={{ fontSize: '10px', margin: 0 }}>R$ {(lote.custoCaixas || custos.custoCaixas).toFixed(2)}</p>
              </div>
            </div>
            
            {tabelaCustos && (
              <div className="mt-2">
                <h3 style={{ fontSize: '11px', margin: '0 0 3px 0', textTransform: 'uppercase', letterSpacing: '0.3px' }} className="font-bold text-gray-800 border-b border-gray-300 pb-1">
                  Análise de Custos
                </h3>
                <table className="w-full border-collapse border border-gray-300" style={{ fontSize: '10px' }}>
                  <thead>
                    <tr className="bg-gray-200">
                      <th className="border border-gray-300 p-1 text-left" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Unidade</th>
                      <th className="border border-gray-300 p-1 text-right bg-yellow-100" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Filé (R$)</th>
                      <th className="border border-gray-300 p-1 text-right bg-blue-100" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Embalagem (R$)</th>
                      <th className="border border-gray-300 p-1 text-right bg-green-100" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Serviço (R$)</th>
                      <th className="border border-gray-300 p-1 text-right bg-purple-100" style={{ fontSize: '9px', textTransform: 'uppercase' }}>Total (R$)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 p-1 font-medium">Pacote</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoFile.pacote)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoEmbalagem.pacote)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoServico.pacote)}</td>
                      <td className="border border-gray-300 p-1 text-right font-bold">R$ {formatarMoeda(tabelaCustos.custoTotal.pacote)}</td>
                    </tr>
                    <tr className="bg-yellow-50">
                      <td className="border border-gray-300 p-1 font-medium">KG</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoFile.kg)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoEmbalagem.kg)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoServico.kg)}</td>
                      <td className="border border-gray-300 p-1 text-right font-bold">R$ {formatarMoeda(tabelaCustos.custoTotal.kg)}</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-1 font-medium">Caixa</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoFile.caixa)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoEmbalagem.caixa)}</td>
                      <td className="border border-gray-300 p-1 text-right">R$ {formatarMoeda(tabelaCustos.custoServico.caixa)}</td>
                      <td className="border border-gray-300 p-1 text-right font-bold">R$ {formatarMoeda(tabelaCustos.custoTotal.caixa)}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        {/* Footer */}
        <div className="mt-3 pt-2 border-t border-gray-300 text-center" style={{ fontSize: '9px' }}>
